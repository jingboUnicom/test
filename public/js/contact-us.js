...
document.addEventListener("alpine:init", function () {
  window.Alpine.store("coordinates", {
    initLatitudeLongitude: function initLatitudeLongitude(latitude_value, longitude_value) {
      latitude = parseFloat(latitude_value);
      longitude = parseFloat(longitude_value);
    },
    setLatitudeLongitude: function setLatitudeLongitude(latitude_value, longitude_value) {
      latitude = parseFloat(latitude_value);
      longitude = parseFloat(longitude_value);
